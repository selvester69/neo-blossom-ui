	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'primary-3d': 'var(--shadow-primary)',
				'secondary-3d': 'var(--shadow-secondary)',
				'success-3d': 'var(--shadow-success)',
				'warning-3d': 'var(--shadow-warning)',
				'destructive-3d': 'var(--shadow-destructive)',
			},
			transitionDuration: {
